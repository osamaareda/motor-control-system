...
# 2 "<built-in>" 2
# 1 "../project1.X/ECUAL/LED/led.c" 2
...
# 8 "../project1.X/ECUAL/LED/led.c" 2
# 17 "../project1.X/ECUAL/LED/led.c"
Std_ReturnType led_init(led_config_t *led){
